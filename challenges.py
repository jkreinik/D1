...
def courseView(course_name):
    return """Welcome to {}.""".format(course_name) 
...
def resultView():
    ...
    if request.method == "POST":
        ingredient = request.form.get("ingredient", "Did not recieve a value")
        print (ingredient)
    ...
    response = requests.get(baseurl, params = params) # i = the ingredient that was entered by the user 
